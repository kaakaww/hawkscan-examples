...
function authenticate(helper, paramsValues, credentials) {
	...
	//build request body
	var requestBody = JSON.stringify({"AuthParameters": {"USERNAME": credentials.getParam('username'), "PASSWORD": credentials.getParam('password')}, "AuthFlow": paramsValues.get('auth_flow'), "ClientId": credentials.getParam('client_id')})
